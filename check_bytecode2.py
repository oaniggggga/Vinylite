...
with open('bytecode_out2.txt', 'w') as out:
    ...
    for m in range(method_count):
        ...
        attr_count = struct.unpack('>H', f.read(2))[0]
        out.write(f'  {method_name}: attr_count={attr_count}\n')
        for _ in range(attr_count):
            ...
            if attr_name == 'Code':
                ...
                out.write(f'    Code: code_len={code_len}, has_pop={has_pop}, has_checkcast={has_checkcast}\n')